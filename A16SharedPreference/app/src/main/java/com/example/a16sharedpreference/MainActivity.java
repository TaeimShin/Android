package com.example.a16sharedpreference;
...
/*
SharedPreference
     : 해당 어플리케이션에서 저장하고싶은 데이터가 있을때 단말기에
     파일형태로 보관해주는 기능을 제공한다. 해당 파일은 앱이 삭제되기 전까지 유지되고,
     삭제될때 파일도 같이 삭제된다.
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        디폴트 값으로 두번째 인자에 지정된 값을 사용할 수 있다.
        */
